 ...
 * @author chait
 */
public class CustomerCheckBalancePage extends javax.swing.JFrame {

    /**
     * Creates new form CustomerCheckBalancePage
     */
    public CustomerCheckBalancePage() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerCheckBalancePage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerCheckBalancePage().setVisible(true);
            }
        });
    }
