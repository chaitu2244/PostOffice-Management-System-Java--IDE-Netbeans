 ...
 * @author chait
 */
public class EmployeeParcelPage extends javax.swing.JFrame {

    /**
     * Creates new form EmployeeParcelPage
     */
    public EmployeeParcelPage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Enter Customer's-Id:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmployeeParcelPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmployeeParcelPage().setVisible(true);
            }
        });
    }
